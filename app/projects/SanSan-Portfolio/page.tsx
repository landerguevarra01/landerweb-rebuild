          ...
          <div className="flex flex-col gap-4">
            <AnimatePresence>
              <motion.h1
                ...
                className="text-[40px]"
              >
                SanSan <span className="text-[#DB0102]">|</span> Personal
                Website
              </motion.h1>
              <motion.p
                key="description"
          ...
          <div className="mt-[85px]">
            <AnimatePresence>
              <motion.p
                ...
                className="text-[18px]"
              >
                In the world of visual storytelling, having a platform that
                reflects both creativity and functionality is essential. SanSan
                Personal Website was designed to be more than just a
                portfolio—it’s a seamless, interactive experience that embodies
                SanSan’s design philosophy. Featuring a sleek dark theme, bold
                typography, and an intuitive interface, the website highlights
                branding projects, digital artworks, and design solutions in a
                way that feels immersive and engaging.
                <br />
                <br />
                This project is a collaboration between Jayson “SanSan” San
                Agustin, a passionate Graphic Designer, and me, Lander Guevarra,
                a Front-end Developer. Our goal was to craft a website that not
                only showcases work but also enhances the user's journey through
                thoughtful design and smooth performance.
                <br />
                <br />
                SanSan Personal Website serves as a digital hub for potential
                clients, collaborators, and brands looking for impactful design
                solutions. The fusion of creativity and technology in this
                project makes it a perfect representation of SanSan’s vision in
                the digital world.
              </motion.p>
            </AnimatePresence>
          </div>
        ...
        <div className="flex flex-wrap gap-3 justify-start items-center py-8">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="rounded-[30px] overflow-hidden">
                <Image
                  src="/assets/SanSan/sansan_web_asset_3.png"
                  alt="Hovered Image"
                  width={556}
                  height={268}
                  className=""
