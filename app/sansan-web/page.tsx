        ...
        <div className="grid grid-cols-2 py-8">
          ...
          <div className="mt-[85px]">
            <p className="text-[18px]">
              ...
              branding projects, digital artworks, and design solutions in a way
              that feels immersive and engaging.
              <br />
              <br />
              This project is a collaboration between Jayson “SanSan” San
              Agustin, a passionate Graphic Designer, and me, Lander Guevarra, a
              Front-end Developer. Our goal was to craft a website that not only
              showcases work but also enhances the user's journey through
              ...
              solutions. The fusion of creativity and technology in this project
              makes it a perfect representation of SanSan’s vision in the
              digital world.
            </p>
          </div>
        </div>
